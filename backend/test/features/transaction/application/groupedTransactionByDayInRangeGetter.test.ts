...
import { GroupedTransactionByDayInRangeGetter } from "../../../../src/features/transaction/application/useCases/groupedTransactionByDayInRangeGetter";
import { TransactionAggregateService } from "../../../../src/features/transaction/application/services/TransactionAggregateService";
...
test("GroupedTransactionByDayInRangeGetter - Return grouped transactions by day in a range of dates successfully", async () => {
