...
import { BalanceInRangeGetter } from "../../../../src/features/transaction/application/useCases/balanceInRangeGetter";
...
test("BalanceInRangeGetter - Returns balance in a range of dates successfully", async () => {
